...
Feedback::IoBank::IoBank(HebiFeedbackPtr internal, FeedbackIoPinBank bank)
...
{
  return (hebiFeedbackHasIoPinInt(internal_, bank_, pinNumber) == 1);
}

bool Feedback::IoBank::hasFloat(int pinNumber) const
{
  return (hebiFeedbackHasIoPinFloat(internal_, bank_, pinNumber) == 1);
}

int Feedback::IoBank::getInt(int pinNumber) const
{
  return hebiFeedbackGetIoPinInt(internal_, bank_, pinNumber);
}

float Feedback::IoBank::getFloat(int pinNumber) const
{
  return hebiFeedbackGetIoPinFloat(internal_, bank_, pinNumber);
}
